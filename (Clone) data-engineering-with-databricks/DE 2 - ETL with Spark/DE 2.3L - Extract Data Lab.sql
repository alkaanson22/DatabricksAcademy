...
-- MAGIC %fs ls  dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v02/ecommerce/raw/sales-csv/
-- MAGIC
-- MAGIC
...
create table if not exists sales (order_id LONG, email STRING, transactions_timestamp LONG, total_item_quantity INTEGER, purchase_revenue_in_usd DOUBLE, unique_items INTEGER, items STRING)
using csv
options (header="true", delimeter="|")
 location "dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v02/ecommerce/raw/sales-csv/000.csv"
